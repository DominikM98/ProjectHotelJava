...
public class createReservationLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_reservation_login);
        //Find view by ID
    ...
    private void showDateArrival(final EditText arrival){
        ...
        new DatePickerDialog(createReservationLoginActivity.this, dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
    //Departure calendar
    ...
    private void showTimeArrival(final EditText timeArrival) {
        ...
        new TimePickerDialog(createReservationLoginActivity.this,timeSetListener,calendar.get(Calendar.HOUR_OF_DAY),calendar.get(Calendar.MINUTE),false).show();
    }
    ...
    public void checkIsEmpty(View view) {
        ...
        if(TextUtils.isEmpty(getName)){
            ...
            Intent intent = new Intent(createReservationLoginActivity.this,MainActivity.class);
